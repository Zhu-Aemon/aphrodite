...
"""
# previously in CME1
# I said scraping CME is so effortless
...
def scrape(commodity_code):
    ...
    # technically speaking, the website should be able to detect that to
    ...
    # here is the hack that I have done for you
    ...
    # don't worry, we will talk about how to read it very soon
...
def etl(commodity_code, commodity_name):
    ...
    output['volume'] = output['volume'].replace(',', '')  # no need for type conversion
